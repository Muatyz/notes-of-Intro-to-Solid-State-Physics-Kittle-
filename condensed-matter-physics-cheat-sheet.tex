\documentclass[UTF8,a4paper,1pt,twocolumn]{ctexart}
...
\begin{itemize}
  % \item \textbf{积分公式}.
  % $\int_{-\infty}^{\infty}exp[ix^2]dx=\sqrt{\pi}exp[i\pi/4](\textbf{Fresnel积分公式})$;
  ...
  % $\int_{-\infty}^{+\infty}x^{2n}exp[-\frac{1}{2}ax^{2}]dx=\frac{(2n-1)!!}{a^{n}}\sqrt{\frac{2\pi}{a}}(\textbf{广义Guass积分式})$;
